...
${input:PROJECT_TYPE:Auto-detect|.NET|Java|JavaScript|TypeScript|React|Angular|Python|Multiple|Other} <!-- Primary technology -->
${input:ARCHITECTURE_STYLE:Layered|Microservices|Monolithic|Domain-Driven|Event-Driven|Serverless|Mixed} <!-- Architectural approach -->
${input:CODE_QUALITY_FOCUS:Maintainability|Performance|Security|Accessibility|Testability|All} <!-- Quality priorities -->
${input:DOCUMENTATION_LEVEL:Minimal|Standard|Comprehensive} <!-- Documentation requirements -->
${input:TESTING_REQUIREMENTS:Unit|Integration|E2E|TDD|BDD|All} <!-- Testing approach -->
${input:VERSIONING:Semantic|CalVer|Custom} <!-- Versioning approach -->
