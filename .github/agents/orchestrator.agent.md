---
name: Orchestrator
description: Opus, Codex, Gemini
model: Claude Opus 4.6 (copilot)
tools: ["read/readFile", "agent", "memory/*", "execute"]
---
...
- **Developer** — Writes code, fixes bugs, implements logic
...
### Phase 1: [Name]
- Task 1.1: [description] → Developer
...
- Task 2.1: [description] → Developer
  Files: src/App.tsx
```
...
```
Task 2.1 → Developer: "Implement the theme context. Create src/contexts/ThemeContext.tsx and src/hooks/useTheme.ts"

Task 2.2 → Developer: "Create the toggle component in src/components/ThemeToggle.tsx"
```
...
- Task 2.1: Implement theme context and persistence → Developer
- Task 2.2: Create the toggle component → Developer
(These can run in parallel - different files)

### Phase 3: Apply Theme (depends on Phase 2)
- Task 3.1: Update all components to use theme tokens → Developer
```

### Step 3 — Execute

**Phase 1** — Call Designer for both design tasks (parallel)
**Phase 2** — Call Developer twice in parallel for context + toggle
**Phase 3** — Call Developer to apply theme across components
